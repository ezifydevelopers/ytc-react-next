...
const SpecialcareStaffing = () => {
    ...
    const cards = [
        {
            ...
            "bg": "bg-[#f1f2f2]",
            "text": "YTC Healthcare stands behind every placement with purpose. Our goal extends far beyond filling a role, we strive to improve the quality of life for patients living with long-term or complex conditions. Every healthcare professional we place is aligned with our core mission: to deliver dependable care that is rooted in compassion, trust, and medical excellence."
        },
        {
    ...
    const HealthcareCards = [
        ...
        {
            title: 'Acquired Brain Injury Care Staffing Services',
            description: 'Living with an Acquired Brain Injury (ABI) and the caregiving process for families is an issue that is well understood…',
            img: '/images/03-Acquired-Brain-Injury-Care-Staffing-Services.jpg',
            linkHref: "/service/acquired-brain-injury-care/",
        },
        {
            title: 'Dementia Care Staffing Solutions',
            description: 'Dementia care requires more than just basic experience; patients with dementia must be cared for by the staff with expertise',
            img: '/images/04-Dementia-Care-Staffing-Solutions.jpg',
            linkHref: "/service/dementia-care/",
        },
        {
    ...
    const steps = [
        ...
        {
            id: 2,
            title: "Transparent Recruitment, Every Step of the Way",
            desc: `Our team partners with you from initial consultation to final placement. We maintain open communication 24/7 to ensure your expectations are met. Every decision reflects your care requirements and our commitment to healthcare excellence.`,
            image: "/images/sv12.webp",
        },
        {
            id: 3,
            title: "Clear Terms. No Last-Minute Surprises.",
            desc: `We offer straightforward agreements with no hidden fees or unexpected conditions. Our priority is to strengthen care delivery through predictable, ethical staffing, so your focus stays on outcomes, not paperwork.`,
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-8 sm:py-10 md:py-[55px]">
                    ...
                    <div className="space-y-4 sm:space-y-6 md:space-y-8">
                        <p className="text-xs sm:text-sm font-semibold text-gray-600 flex items-center gap-2">
                            ...
                            <span>
                                Special Care Staffing Made Simple, Reliable, and Life-Changing</span>
                        </p>
...
export default SpecialcareStaffing;
