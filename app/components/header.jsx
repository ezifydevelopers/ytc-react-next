...
const Header = () => {
    ...
    return (
        <div className="">
            <div className="bg-[#009689] px-8 py-1 flex lg:flex-row flex-col md:justify-between items-center">
                <div className='flex'>
                    ...
                    <a href="tel:+13657374000" className='flex gap-2 text-white md:mx-5'>
                ...
                <div className='flex'>
                    ...
                    <a href="tel:+14122182885" className='flex gap-2 text-white md:mx-5'>
