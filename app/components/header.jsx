...
const Header = () => {
    ...
    return (
        <div className='relative'>
            ...
            <header className={`w-full flex items-center justify-between px-6 py-4 bg-white shadow transition-all duration-500 ease-in-out ${isSticky ? '-translate-y-full opacity-0' : 'translate-y-0 opacity-100'}`}>
                    ...
                    <div className='flex justify-between'>
                        <nav className="hidden md:flex items-center space-x-6 font-[500] text-[19px] w-[90%] justify-center">
                            ...
                            <div className="relative group">
                                ...
                                <div className="absolute left-0 mt-2 w-48 origin-top-right bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-50">
                                    <div className="py-1">
                                        <Link href="/blogs" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Blogs</Link>
                                        <Link href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Salary Guide</Link>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="relative group">
                                ...
                                <div className="absolute left-0 mt-2 w-56 origin-top-right bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-50">
                                    <div className="py-1">
                                        <Link href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Healthcare Workers</Link>
                                        <Link href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Homecare Services</Link>
                                        <Link href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Special Care Services</Link>
                                        <Link href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Healthcare Facilities</Link>
                                    </div>
                                </div>
                            </div>
                        ...
                        <Link href="/quote" className='w-[10%]'>
                            <button className="bg-teal-600 font-[700] w-[100%] flex justify-center items-center gap-2 h-[51px] hover:bg-teal-700 text-white text-sm px-4 py-2 rounded-md">
                                Free Guide <svg fill='white' xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="20" height="20"><path d="M23.12,9.91,19.25,6a1,1,0,0,0-1.42,0h0a1,1,0,0,0,0,1.41L21.39,11H1a1,1,0,0,0-1,1H0a1,1,0,0,0,1,1H21.45l-3.62,3.61a1,1,0,0,0,0,1.42h0a1,1,0,0,0,1.42,0l3.87-3.88A3,3,0,0,0,23.12,9.91Z" /></svg>
                            </button>
                        </Link>
                    </div>
                </div>
            ...
            <header className={`w-full flex items-center justify-between px-16 py-4 bg-white shadow fixed top-0 z-50 transition-all duration-500 ease-in-out ${isSticky ? 'translate-y-0 opacity-100' : '-translate-y-full opacity-0'}`}>
                <div className="flex items-center space-x-4 w-[20%]">
                    <Link href="/">
                        <Image
                            src="/images/logo.webp"
                ...
                <div className='w-[80%]'>
                    <div className='flex justify-between'>
                        ...
                        <Link href="/quote" className='w-[10%]'>
                            <button className="bg-[#09243C] font-[700] w-[100%] flex justify-center items-center gap-2 h-[51px] hover:bg-teal-700 text-white text-sm px-4 py-2 rounded-md">
