...
const HealthcareFacilities = () => {
    ...
    const cards = [
        {
            ...
            "bg": "bg-[#f1f2f2]",
            "text": "Recruiting medical professionals is only the first step. We continue working alongside each client to ensure that placements lead to measurable results. Our goal is to deliver permanent medical staffing services that support consistent, high-quality patient care through expert-certified talent."
        },
        {
    ...
    const HealthcareCards = [
        {
            title: 'Childcare Centers Staffing Services',
            description: 'Our staffing services connect childcare centers with skilled and certified team members.',
            img: '/images/02-Childcare-Centers-Staffing-Services.jpg',
            linkHref: "/service/staff-for-childcare-centers/",
        },
        {
            title: 'Healthcare Staff For Dental Clinics',
            description: 'Patients with dental problems always look for quick attention. Staffing gaps can disrupt patient care and slow down operations.',
            img: '/images/03-Healthcare-Staff-For-Dental-Clinics.jpg',
            linkHref: "/service/staff-for-dental-facilities/",
        },
        {
            title: 'Staffing Services For Clinics',
            description: 'YTC Healthcare connects clinics and other medical facilities with experienced healthcare professionals, ensuring smooth operations.',
            img: '/images/04-Staffing-Services-For-Clinics.jpg',
            linkHref: "/service/staff-for-clinics/",
        },
        {
            title: 'Healthcare Staffing For Hospitals Needs',
            description: 'Hospitals need comprehensive plans to ensure both patient safety and quality care while addressing key concerns, such as patient load,…',
            img: '/images/05-Healthcare-Staffing-For-Hospitals-Needs.jpg',
            linkHref: "/service/healthcare-staff-for-hospitals/",
        },
    ];
    ...
    const steps = [
        {
            id: 1,
            title: "Share Your Healthcare Staffing Needs",
            desc: `Let us know what your facility requires, and we will connect you with certified professionals ready to support your care environment. From clinical teams to support staff, our healthcare workforce solutions address shortages without delay. `,
            linkText: "",
            linkHref: "",
            suffix: "",
        ...
        },
        {
            ...
            desc: `We involve you at every stage of the hiring journey to ensure the right match. Our 24/7 recruitment team works to make onboarding seamless for facilities of all sizes. Trust our approach to deliver temporary healthcare staffing that never compromises quality.`,
            image: "/images/sv12.webp",
        },
        {
            id: 3,
            title: "Clear Terms With No Hidden Fees ",
            desc: `We believe in simplicity and transparency. Our agreements are straightforward, with no hidden costs—just the assurance of working with a reliable allied health staffing agency focused on long-term relationships.`,
    ...
    return (
        <div>
            <Head>
                <link rel="canonical" href="https://ytchealthcare.com/healthcare-facilities/" />
            </Head>
            <Header />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-8 sm:py-10 md:py-[55px]">
                    ...
                    <div className="space-y-4 sm:space-y-6 md:space-y-8">
                        <p className="text-xs sm:text-sm font-semibold text-gray-600 flex items-center gap-2">
                            ...
                            <span>
                                Expert Staffing Support for Healthcare Facilities of All Sizes
                            </span>
                        </p>

                        <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold leading-tight text-gray-900">
                            Uniting Healthcare Providers
            ...
            <section className="px-4 py-10 mx-5 md:pb-16 md:pt-4 rounded-[20px]" style={{ background: "linear-gradient(to bottom, #e2f0f7, rgba(227, 241, 248, 0));" }}>
